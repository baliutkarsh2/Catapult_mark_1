          ...
          <div className="max-w-sm mx-auto">
            <form>
              ...
              <div className="flex flex-wrap -mx-3 mt-6">
                <div className="w-full px-3">
                  <Link href="/preferences" className="btn text-white bg-purple-600 hover:bg-purple-700 w-full">Next</Link>
                </div>
              </div>
            </form>
            <div className="text-gray-400 text-center mt-6">
              <Link href="/input-year" className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Back</Link>
            </div>
          </div>
        </div>
      </div>
