...
import FeatImage01 from '@/public/images/meow.jpg'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <h1 className="h2 mb-4">Plan Your Degree</h1>
          ...
          <div className="grid gap-20">
            ...
            {/* 1st item - Adjusted to position image to the left and increase its size */}
<div className="md:grid md:grid-cols-12 md:gap-6 items-center">
  {/* Image */}
  <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-6 lg:col-span-7 mb-8 md:mb-0" data-aos="fade-up">
    <Image className="max-w-full mx-auto md:max-w-none h-auto" src={FeatImage01} width={594} /* Increased width */ height={445} /* Increased height */ alt="Features 01" />
  </div>
  {/* Content */}
